...
public class FileHelp {
    ...
    public static String getTsdzImei() {
        ...
        if (FileHelp.isSdCardMounted()) {
            ...
            try {
                ...
                LogUtil.i("--read--content--" + content);
                if (content.contains("-")) {
                    String replace = content.replace("-", "");
                    LogUtil.i("--read--content--" + replace);
                    return replace;
                } else {
                    return content;
                }
    ...
    public static void write2File(Context context, Object datas, String fileName,String acpath) {
