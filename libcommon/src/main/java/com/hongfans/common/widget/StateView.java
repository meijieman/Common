package com.hongfans.common.widget;
...
public class StateView extends RelativeLayout {
    ...
    private void initLoadingView(Context ctx) {
        ...
        int border = DensityUtil.dip2px(CommonConfig.getContext(), IMAGE_BORDER);
        ...
        int width = DensityUtil.dip2px(CommonConfig.getContext(), 30);
        LinearLayout.LayoutParams params3 = new LinearLayout.LayoutParams(width, width);
        params3.gravity = Gravity.CENTER_VERTICAL;
        params3.rightMargin = DensityUtil.dip2px(CommonConfig.getContext(), 8);
